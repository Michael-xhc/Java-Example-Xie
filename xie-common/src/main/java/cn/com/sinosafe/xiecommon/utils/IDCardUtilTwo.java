 ...
 * fileName: IDCardUtilTwo.java
 * date: 2020-06-28 10:23
 ...
 * @description: 身份证校验
 * @packageName: cn.com.sinosafe.xiecommon.utils
 * @className: IDCardUtilTwo
 * @author: xiehanchun
 * @data: 2020-06-28 10:23
 * @version: v1.0
...
public class IDCardUtilTwo {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String IdCard="610821200612226121";
        //将身份证最后一位的x转换为大写，便于统一
        IdCard = IdCard.toUpperCase();
        System.out.println("jieguo:"+iDCardValidate(IdCard));
    }
}
