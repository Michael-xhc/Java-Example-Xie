...
public class AgentConstants {
	 ...
	 */
	public static final long LOGIN_TOKEN_EXPIRE_TIME = 60 * 60 * 24 * 30;
	 ...
	 * 邮箱验证码有效时间
	 */
	public static final long EMAIL_MSG_EXPIRE_TIME = 5 * 60 * 1000;
	 ...
	 * 年均佣金估算默认值,单位：元
	 */
	public static final long DEFAULT_AGENT_PAI = 6800;
	 ...
	 * 获得佣金及奖励默认冻结小时
	 */
	public static final int FREEZE_HOURS = 72;
	 ...
	 * 二维码识别链接
	 */
	public static final String QR_URL_REDIS_KEY = "qr_code_redis_key";
     ...
     * 无新增权限提示语
     */
    public static final String ADDJURISDICTION = "登录用户不是管理员角色，无新增权限";

    /**
     * 无修改权限提示语
     */
    public static final String UPDATEJURISDICTION = "登录用户不是管理员角色，无修改权限";

    /**
     * 无删除权限提示语
     */
    public static final String DELJURISDICTION = "登录用户不是管理员角色，无删除权限";
